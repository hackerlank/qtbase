...
void tst_QArrayData::allocate_data()
{
    ...
    struct {
        ...
        { "Default", QArrayData::DefaultAllocationFlags, false, true, shared_empty },
...
#endif
        { "Grow", QArrayData::GrowsForward, false, true, shared_empty }
    };
...
void tst_QArrayData::setSharable_data()
{
    ...
    QArrayDataPointer<int> nonEmpty(QTypedArrayData<int>::allocate(5,
                QArrayData::DefaultAllocationFlags));
